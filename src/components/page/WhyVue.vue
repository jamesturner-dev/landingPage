  ...
  <div class="overflow-hidden bg-gray-50 py-10">
    <div class="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-prose text-base lg:max-w-none">
        <h2 class="text-lg font-semibold text-sky-600">Why I choose VueJs as my prefered framework</h2>
        <p class="mt-2 text-3xl font-bold leading-8 tracking-tight text-gray-600 sm:text-3xl">
          What makes Vue different
        </p>
      </div>
      <div class="relative z-10 mx-auto max-w-prose text-base lg:mx-0 lg:max-w-5xl lg:pr-72">
        <p class="text-lg text-gray-500">
          Javascript frameworks are hot right now and most of them are widely regarded as some of the best ways of
          developing
          back-end or front-end applications. With all these choices at our fingertips, why use Vue? Fortunately for
          you, I'm
          hoping this blog post will motivate you to choose Vince by giving you the 5 top benefits.
        </p>
      </div>
