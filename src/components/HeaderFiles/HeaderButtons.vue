<template>
  <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
    ...
    <a v-on:click="buttonHandler('Sign In')"
      class="ml-5 inline-flex items-center justify-center whitespace-nowrap rounded border border-transparent bg-gradient-to-r from-purple-600 to-sky-600 bg-origin-border px-3 py-1 text-base font-medium text-white shadow-sm hover:from-purple-700 hover:to-sky-700">
      Sign in
    </a>
  </div>
</template>
